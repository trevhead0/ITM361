...
(function(){
  var num=6;
  var x = num * 2;
  console.log('The value of x is:', x, 'It should be 12.');
}());
...
console.log((function(){var i;return i;})()) // should be 'undefined', not 3
console.log(i);
...
console.log("The scope of the variable is global, however the new x value is a local variable inside of the function if ran as x = addtwo(x) then it would change global variable")
